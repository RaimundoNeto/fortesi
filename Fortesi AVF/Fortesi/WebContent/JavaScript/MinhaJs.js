...
//Fomulário de Agenda invalidar campos vazios
function ValidarFormAgenda(form3){
	if(form3.cliente.value == ""){
		alert("Selecione um cliente");
		form3.cliente.focus();
		return false;
	}
	if(form3.ntelefone.value == ""){
		alert("Preencha o Campo Telefone ");
		form3.ntelefone.focus();
		return false;
	}
	if(form3.NEmail.value == ""){
